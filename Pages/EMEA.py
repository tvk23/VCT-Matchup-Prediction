...
# Set page config
st.set_page_config(page_title="VCT EMEA", layout="wide")

left_co, left_co2, cent_co,right_co, last_co = st.columns(5)
with cent_co:
    st.image("https://i.namu.wiki/i/lxyC2MyoQpPTF0z8mJ5prdDS6twqe8t3X1CY2YXNUbMAPdekfHShrlLY3ebMdx5iZQgaXpygGNlV90w2Fw2f0Q.svg")
...
teams = {
    "Team Vitality": {"rating": 4.5, "color": "navy"},
    "Team Liquid": {"rating": 9.0, "color": "blue"},
    "Team Heritics": {"rating": 6.5, "color": "gold"},
    "FUT Esports": {"rating": 8.0, "color": "red"},
    "FNATIC": {"rating": 9.5, "color": "orange"},
    "BBL Esports": {"rating": 5.5, "color": "indigo"},
    "Gentle Mates": {"rating": 4.0, "color": "green"},
    "GIANTX": {"rating": 6.0, "color": "blue"},
    "KOI": {"rating": 7.5, "color": "purple"},
    "NAVI": {"rating": 7.0, "color": "yellow"},
}
...
st.title("VCT EMEA Head 2 Head Predictor")
